...
function App() {
  return (
    ...
    <a href="./index.html">
      <img className="imgCard" src={logoAwesome} alt="Awesome profile cards logo" />
    </a>
  </header>
  ...
  <main className="create_card_main">
    <section className="card_hero">
      ...
      <div className="card-preview">
        <div className="card-preview__header js-card-preview-header">
          <h3 className="card-preview__title js-preview_name">Nombre apellido</h3>
          <p className="card-preview__subtitle js-preview_job">Front-end developer</p>
        </div>
        ...
        <nav className="card-preview__nav">
          <ul className="card__socialmedia">
            ...
            <li className="card__socialmedia--item">
              <a href="mailto:email@email.com" className="js-preview_email" alt="email">
    ...
    <section className="background_features">
      <section className="container containerdesign">
        <div className="design js-legendDesign js-legend" id="designContent">
          <div className="icontitle">
            <i className="far fa-object-ungroup" alt="icon"></i>
            <h4 className="designtitle">Diseña</h4>
          </div>
          <i className="fas fa-chevron-up js-arrowdown-design js_arrows" alt="icon"></i>
        </div>

        <section className="paletteandcolours js-sectionDesign js_content" id="designContent">
          <p className="colourstitle">Colores</p>

          <section className="colours">
            <form className="palettes">
              <input type="radio" defaultValue="colours1" id="colours1" name="colourpalette" className="js_colourpalette" defaultChecked />
              <input type="radio" defaultValue="colours2" id="colours2" name="colourpalette" className="js_colourpalette" />
              <input type="radio" defaultValue="colours3" id="colours3" name="colourpalette" className="js_colourpalette" />
            </form>
      ...
      <section className="section__form container">
        <div className="section__bar js-legendFill js-legend" id="formContent">
          ...
          <i className="fas fa-chevron-down js-arrowdown-fill js_arrows" alt="icon"></i>
        </div>
        ...
        <form action="" method="post" className="form js-form">
          <div className="js-sectionFill js_content collapsed" id="formContent">
            <fieldset>
              ...
              <input type="text" placeholder="Ej: Sally Jill" name="full_name" id="name" className="form__input js-full_name"
                defaultValue="" required
                pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" />
              <label htmlFor="job" className="form__label">Puesto</label>
              <input type="text" placeholder="Ej: Front-end unicorn" name="job" id="job" className="form__input js-job"
                pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}"
                required />

              <label htmlFor="image" className="form__label">Imagen de perfil</label>
              <div className="form__image-section">
                <label className="form__image-section--add js__profile-trigger" htmlFor="photo">Añadir imagen</label>
                <div className="form__image-section--preview js__profile-preview"></div>
                <input type="file" name="photo" id="photo" className="collapsed js__profile-upload-btn" required />
              </div>

              <label htmlFor="email" className="form__label">Email</label>
              <input type="email" placeholder="Ej: sally-hill@gmail.com " name="email" id="email" className="form__input js-email"
                required />
              ...
              <input type="text" placeholder="Ej: @sally-hill" name="github" id="github" className="form__input js-github" />
            </fieldset>
          </div>
      ...
      <section className="container containerShare">
        <div className="titleShare js-legendShare js-legend" id="shareContent">
          <div className="titleShare__titleIcon">
            <i className="fas fa-share-alt"></i>
            <h4 className="titleShare__title">Comparte</h4>
          </div>
          <i className="fas fa-chevron-down js-arrowdown-share js_arrows" alt="icon"></i>
        </div>

        <div className="containerButton js-sectionShare js_content collapsed" id="shareContent">
